...
def get_previous_day_emission(count):
...
def get_previous_week_emission(count):
    ''' return total emission for count weeks '''
    return get_previous_day_emission(count*7)

def get_previous_month_emission(count):
    ''' return total emission for count months '''
    return get_previous_day_emission(count*30)

def get_previous_day_sum(count):
...
def get_previous_week_sum(count):
    ''' return total sum for count weeks '''
    return get_previous_day_sum(count*7)

def get_previous_month_sum(count):
    ''' return total sum for count months '''
    return get_previous_day_sum(count*30)
